                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                        ...
                        <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                            <a href="{{ route('breeding.create') }}" class="flex items-center justify-center text-white bg-green-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">
                                        @if($breeding->cattle->herd->user->is(Auth::user()) || $breeding->sire->herd->user->is(Auth::user()))
                                        <td class="px-4 py-3 flex items-center">
                                            <x-dropdown class="relative z-50">
                                                ...
                                                <x-slot name="content">
                                                    <x-dropdown-link :href="route('breeding.edit', $breeding)">
                                                        {{ __('Edit') }}  
                                                    </x-dropdown-link>
                                                        <form method="POST" action="{{ route('breeding.destroy', $breeding) }}">
                                                            @csrf
                                                            @method('delete')
                                                            <x-dropdown-link :href="route('breeding.destroy', $breeding)" onclick="event.preventDefault(); this.closest('form').submit();" class="text-red-500">
                                                                {{ __('Delete') }}
                                                            </x-dropdown-link>
                                                        </form>
                                                </x-slot>
